...
$.ajax({
    ...
    $(".addToCart").click(function(){
        ...
        let objekt = data[thisitemID];
        let serialJS = JSON.stringify(objekt);
        localStorage.setItem(thisitemID,serialJS);
